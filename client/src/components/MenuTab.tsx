          ...
          <div className="menu-tab text-center">
            <div className="filters-container grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 max-w-screen-md mx-auto">
              <div className="filter-wrapper">
                <div className="filter inline-flex flex-col items-center text-lg cursor-pointer transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-105 duration-300 border-none rounded-lg p-4 bg-gradient-to-r from-dark-accent to-dark-secondary" onMouseEnter={handleHover}>
